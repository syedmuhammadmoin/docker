...
import {IApiResponse} from "../../../views/shared/IApiResponse";
...
export class AuthService {
  ...
  login(email: string, password: string, orgId: any): Observable<any> {
  ...
  requestResetPassword(email): Observable<IApiResponse<boolean>> {
    return this.http.post<IApiResponse<boolean>>(AppConst.remoteServiceBaseUrl + 'auth/users/forgetPassword', {email});
  }

  getApplicationToken(orgId): Observable<IApiResponse<any>> {
    return this.http.post<IApiResponse<any>>(AppConst.remoteServiceBaseUrl + 'Auth/openOrganization/' + orgId, {})
  }

  refreshAuthToken(orgId) {
    this.getApplicationToken(orgId)
      .subscribe((res) => {
        if (res.isSuccess) {
